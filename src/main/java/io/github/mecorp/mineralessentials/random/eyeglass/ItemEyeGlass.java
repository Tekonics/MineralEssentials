 ...
 */
public class ItemEyeGlass extends ItemArmor
{
    public ItemEyeGlass(ArmorMaterial material, int armorType, String name)
    {
    ...
    {
        if(stack.getItem()== EyeGlass.EyeGlass)
        {
            return Reference.MOD_ID + ":models/armor/EyeGlass.png";
        }
        else
        {
            return null;
